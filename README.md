...
[![codecov](https://codecov.io/gh/Nordln/project_template/branch/main/graph/badge.svg?token=project_template_token_here)](https://codecov.io/gh/Nordln/project_template)
[![CI](https://github.com/Nordln/project_template/actions/workflows/main.yml/badge.svg)](https://github.com/Nordln/project_template/actions/workflows/main.yml)

Awesome project_template created by Nordln

## Install

from source
```bash
git clone https://github.com/Nordln/project_template project_template
cd project_template
make install
```
...
```bash
$ project_template run --port 8080
```

or

```bash
python -m project_template run --port 8080
```

or

```bash
$ uvicorn project_template:app
```
...
Usage: project_template [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ project_template create-user --help
Usage: project_template create-user [OPTIONS] USERNAME PASSWORD
...
```bash
project_template create-user admin admin --superuser
```
...
Run with `project_template run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `project_template create-user`.
...
-----------------------------------------------------
project_template/__init__.py              4      0   100%
project_template/app.py                  16      1    94%
project_template/cli.py                  21      0   100%
project_template/config.py                5      0   100%
project_template/db.py                   10      0   100%
project_template/models/__init__.py       0      0   100%
project_template/models/content.py       47      1    98%
project_template/routes/__init__.py      11      0   100%
project_template/routes/content.py       52     25    52%
project_template/routes/security.py      15      1    93%
project_template/routes/user.py          52     26    50%
project_template/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in project_template/default.toml.
