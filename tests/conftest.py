...
# WARNING: Ensure imports from `project_template` comes after this line
from project_template import app, settings, db  # noqa
from project_template.cli import create_user, cli  # noqa
