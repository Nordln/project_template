...
description = """
project_template API helps you do awesome stuff. 🚀
"""
...
app = FastAPI(
    ...
    terms_of_service="http://project_template.com/terms/",
    contact={
        "name": "Nordln",
        "url": "http://project_template.com/contact/",
        "email": "Nordln@project_template.com",
    },
    license_info={
        "name": "The Unlicense",
